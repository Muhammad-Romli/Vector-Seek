...
def convert_file_dict_to_dict_metadata(list_of_file_dict: list[dict[str,str]]) -> list[list[dict[str | None, str | list[str] | None]]]:
    ...
    for dict in list_of_file_dict:
        ...
        dict_metadata: list[dict[str | None, str | list[str] | None]]
